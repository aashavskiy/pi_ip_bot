...
async def error_handler(update: object, context: CallbackContext) -> None:
    ...
    if isinstance(update, Update):
        ...
        logging.error("Update is None or not an instance of Update, cannot send error message to user.")
        await context.bot.send_message(chat_id=ADMIN_ID, text="An error occurred but the update is None or invalid. Check the logs for more details.")
